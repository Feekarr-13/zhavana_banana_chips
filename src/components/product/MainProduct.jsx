...
const MainProduct = ({ product, setCurIndex, setIsDetailActive }) => {
  ...
  useEffect(() => {
    ...
    tglnTl
      .to(taglineRef1.current, { width: "100%" })
  ...
  const prevImg = () => {
    setCurIndex((prevIndex) => (prevIndex === 0 ? 2 : prevIndex - 1));
    handleShake(imgPdtRef);
  };

  const nextImg = () => {
    setCurIndex((prevIndex) => (prevIndex === 2 ? 0 : prevIndex + 1));
    handleShake(imgPdtRef);
  };
  ...
  return (
    <div className="max-w-[1300px] m-auto py-10" id="produk">
      ...
      <div className="secTitle text-center mb-5">
        ...
        <h1
          id="titleProduct"
          className={`${style.headingS} text-5xl sm:text-[64px] bg-clip-border overflow-hidden`}
        >
          {product.title}
        </h1>
      </div>
      ...
      <div className="slide1 grid sm:grid-cols-3 grid-cols-1">
        ...
        <div className="left sm:pt-20 text-center sm:text-start z-[2]">
          <div className="tagline mb-8 sm:max-w-sm overflow-hidden relative">
            <div
              ref={taglineRef1}
              className="w-0 h-full bg-yellow-300 absolute"
            ></div>
            <p ref={taglineRef2} className="opacity-0 invertSelection">
              {product.tagline}
            </p>
          </div>
          <button
        ...
        <div className="mid p-5 flex flex-col justify-center items-center z-[2]">
          ...
          <div className="arrows w-full flex justify-center items-center">
            ...
            >
              <svg
                className={`arrRight ${style.arrow}`}
                height="30"
                viewBox="0 0 91 30"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  d="M90.4142 16.4142C91.1953 15.6332 91.1953 14.3668 90.4142 13.5858L77.6863 0.857864C76.9052 0.0768156 75.6389 0.0768156 74.8579 0.857864C74.0768 1.63891 74.0768 2.90524 74.8579 3.68629L86.1716 15L74.8579 26.3137C74.0768 27.0948 74.0768 28.3611 74.8579 29.1421C75.6389 29.9232 76.9052 29.9232 77.6863 29.1421L90.4142 16.4142ZM0 17H89V13H0V17Z"
                  fill="#341D12"
                />
              </svg>
            </div>
        ...
        <div className="right relative flex justify-center items-center z-[2]">
          <div className="w-fit hidden sm:block sm:absolute md:static bottom-0 lg:static">
            ...
            >
              <path
                d="M125 17.8615C119.352 10.3592 106.053 -2.93804 98.0435 3.89166C88.0311 12.4288 116.528 27.9508 111.137 40.3685C105.745 52.7861 73.3975 10.8766 65.6956 20.9659C57.9937 31.0552 101.894 60.5471 91.1118 72.1887C80.3292 83.8302 25.6459 10.1005 17.944 33.3835C10.2422 56.6666 81.8695 83.8302 63.385 106.337C44.9005 128.844 17.9441 77.6214 1 68.3082"
                stroke="#341D12"
                strokeWidth="4"
              />
            </svg>
          ...
          <div
            ref={listRef}
            className="hidden sm:flex -rotate-90 space-x-6 absolute top-1/4 -right-1/3 translate-y-32"
          >
            <p>Autentik</p>
            <p>Renyah</p>
            <p>Kriuk</p>
